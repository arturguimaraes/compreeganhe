    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a href="<?=base_url()?>">
                        <img src="assets/img/logo.png" alt="Logo Compre & Ganhe" class="hidden-xs hidden-sm" style="height: 50px; padding: 0; width: auto;">
                ...
                <div class="navi">
                    <ul>
                        <?php if($this->adminModel->checkLogin()) { ?>
                            ...
                            <li><a href="adminMessages"><i class="fa fa-envelope" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Enviar Mensagem</span></a></li>
                            <li><a href="adminMessagesReceived"><i class="fa fa-envelope" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Mensagens de Usuários</span></a></li>
